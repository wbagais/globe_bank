<?php
  ...
  //shift subjects
  //$current_id=0 because there are no id 0 in the database so it will do nothing
  ...
  function validate_page($page) {
    ...
    if(is_blank($page['content'])){
      $errors[] = "Comtent cannot be blank.";
    }
  ...
  function validate_admin($admin, $options=[]) {
    ...
    if($password_required) {
      ...
      }elseif (!has_length_greater_than($admin['password'], 12)) {
        $errors[] = "Email must contain 12 or more characters.";
