...
<div id="main">
  ...
  <div id="page">
    ...
    if(isset($page)){
      ...
      //Another way which will delete all tags and convert <br> to new line
      //echo nl2br(strip_tags($page['content']));
    } else {
      //Show the homepage
      //The homepage content could:
      //* be static content (here or in a shared file)
      //* shoe the first page from navigation
      //* br in the database but add code to hide in the nav
